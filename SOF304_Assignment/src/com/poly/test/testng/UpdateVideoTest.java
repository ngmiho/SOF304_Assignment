...
public class UpdateVideoTest {
	...
	@DataProvider(name = "updateVideoData")
	public Object[][] data() throws IOException {
		XSSFWorkbook workbook = ExcelUtils.getWorkbook(SRC);

		XSSFSheet sheet = workbook.getSheet("UPDATE_VIDEO_DATA");
	...
	private void updateVideo(String title, String description) throws InterruptedException {
		...
		WebElement updateBtn = driver
				.findElement(By.xpath("/html/body/div[2]/div/div/div/div[1]/div/div/div/div[2]/div/div/form/div[6]/div[2]/button"));
		Actions actions = new Actions(driver).click(updateBtn);
		actions.build().perform();
	}
	
	@Test(dataProvider = "updateVideoData")
	public void updateVideoTest(String videoId, String title, String description, String expected) throws InterruptedException {
		...
		data.setAction("Test Update Video Function");
	...
	public void destroy() throws IOException {
		data.writeLog(SRC, "UPDATE_VIDEO_RESULT", logs);
	}
}
